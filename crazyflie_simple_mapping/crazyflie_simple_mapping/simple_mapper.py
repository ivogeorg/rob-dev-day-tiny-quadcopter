...
class SimpleMapperMultiranger(Node):
    def __init__(self):
        ...
        ## subsribe to the right scan and odometry topic
        ...
        # start a map to odom broadcaster
    ...
    def scan_subscribe_callback(self, msg):
        ...
        # for each scan received, add them to the map if within range
        self.ranges = msg.ranges
        self.range_max = msg.range_max
        #rotate the points based on pose and get x y coordinates
        ...
        if self.position_update is False:
            return
        # Draw lines if valid data is received
        ...
        # Send out occupancy grid map made
        msg = OccupancyGrid()
